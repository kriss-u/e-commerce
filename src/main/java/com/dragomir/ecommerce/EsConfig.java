...
@Configuration
@EnableElasticsearchRepositories(basePackages = "com.dragomir.ecommerce.repositories")
public class EsConfig {
    ...
    public Client client() throws Exception {
        ...
        return client.addTransportAddress(new InetSocketTransportAddress(InetAddress.getByName(EsHost), EsPort));
    }
